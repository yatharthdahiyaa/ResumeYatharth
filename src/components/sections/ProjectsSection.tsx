...
const ProjectCard = ({ project, index }: { project: typeof projects[0], index: number }) => {
  ...
  return (
    ...
    >
      <div
        className="tech-card group relative h-full transform-style-3d"
        style={{ transform: "translateZ(0)" }}
      >
        {/* Animated border glow */}
        <div
          className={`absolute inset-0 rounded-lg pointer-events-none transition-opacity duration-300 ${hoveredProject === project.title ? 'opacity-100 animate-pulse-glow' : 'opacity-0'
            }`}
        ...
        <div className="relative z-10 h-full flex flex-col pt-8 transform-style-3d">
          {/* Project Title */}
          <motion.h3
          ...
          {/* Problem Statement */}
          <p
            className="text-muted-foreground text-xs lg:text-sm mb-4 leading-relaxed line-clamp-2"
            style={{ transform: "translateZ(30px)" }}
          >
            {project.problem}
          </p>
